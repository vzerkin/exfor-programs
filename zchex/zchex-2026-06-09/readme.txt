...
Updated:
    ...
    2021-05-21  V.Zerkin
                - correctly checking muptiple code, example:
                  ADD-RES:(DECAY,G-SPEC,STRUC)
    2021-05-24  V.Zerkin
    ...
    2022-06-09  V.Zerkin
                ...
                - debug: suppress output "^^^^^^^^^^" for blank lines
                  if "no warnings", example:23327006
    2023-04-25  V.Zerkin
                - improved indication of conflict Dict236.ResFlg=[.] with in
                  SF4:must be empty
                - indication of: Common|Data.ResonanceParam requires
                  SF58.ReacType:RP=[.] in Dict-236
    ...
    2025-08-08  V.Zerkin
                ...
                - added Entry statistics to Pass-2 terminal-output:
                  +Lines, +Errors, +Warnings
                - added timestamp to terminal-output and report
    2025-09-30  V.Zerkin
                - allow file without label: TRANS/PRELIM/LIB/REQUEST;
                  file can start with ENTRY and end with ENDENTRY
    2025-10-01  V.Zerkin
                - avoid checking ACC/SEQ in file label record TRANS/PRELIM
    2026-06-09  V.Zerkin
                - checking values in ELEMENT column

History:
    ___________________________________
    1998-2001
    Originally written on VMS:
    by Ms. Victoria McLane
    ...
    ___________________________________
    2001-2023
    Ported to Windows and Linux (2001),
    adopted to MacOS (2007).
    ...
    ___________________________________
    2024-2026
    Development/improvement/debugging:
    by Dr. Viktor Zerkin
