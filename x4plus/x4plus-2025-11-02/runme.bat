...
call x4tox4plus.bat O0050002.x4 -www2dd:iaea -nocolor -nocsv
...
@echo Example with Warning: ERR-S=0
call x4tox4plus.bat 23147004.x4
call x4tox4plus.bat 23147004.x4 -o:23147004.x4.x4plus.html -nojs
